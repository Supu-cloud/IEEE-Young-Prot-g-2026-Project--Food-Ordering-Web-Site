import { Menu, ShoppingBag, UserRound, Utensils, X } from 'lucide-react'
...
export function Header() {
  ...
  return <header className="site-header"><div className="container header-inner">
    ...
    {user ? <button className="user-link user-button" onClick={signOut}><span className="avatar"><UserRound size={19} /></span><span>Sign out</span></button> : <Link className="user-link" to="/login"><span className="avatar"><UserRound size={19} /></span><span>Sign in</span></Link>}
  </div></header>
}
