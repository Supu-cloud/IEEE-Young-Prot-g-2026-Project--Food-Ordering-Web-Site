...
export function AccountConnectedPage() {
  ...
  return <div className="page container"><div className="account-layout">
    ...
    <div className="account-content">
      ...
      <section className="account-section" id="preferences"><h2>Preferences</h2><p className="profile-muted">Your account preferences are managed securely through Foodie.</p></section>
